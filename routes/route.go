...
func (r *RouteController) InitRoute(e *echo.Echo) {
	...
	doctorAuth.GET("/auth/facebook/login", r.doctorController.FacebookLogin)       // Facebook Login
	doctorAuth.GET("/auth/facebook/callback", r.doctorController.FacebookCallback) // Facebook Callback
